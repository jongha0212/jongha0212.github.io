...
1. ID 관리 구성
  * id 간리 설정을 변경할 수 있으며 **OIDC**, **LDAPS** 두가지가 있음
...
1. Tanzu Kubernetes Cluster 구성 파일 생성
  ...
  * .tanzu/tkg/clusterconfigs 디렉토리에 management cluster 구성 후 생성된 yaml 파일을 사용
    ...
    VSPHERE_RESOURCE_POOL: /Datacenter/host/x86-Cluster/Resources/CUNi_3.0/tkg		# 리소스 풀
    VSPHERE_SERVER: 10.100.1.110
    VSPHERE_SSH_AUTHORIZED_KEY: |-
        ssh-rsa ............ jongha0212@datasolution.kr
